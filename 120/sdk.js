...
( () => {
    ...
    const o = () => {
        ...
        o = function*() {
            return new Promise(( (e, r) => {
                ...
                window.addEventListener("message", (function r(a) {
                    ...
                    n && n.messageId === o && (window.removeEventListener("message", r),
                    clearTimeout(t),
                    e(n.payload))
                }
                )),
        ...
        new Promise(( (t, a) => {
            var n = e => {
              ...
              , i = e => e.done ? t(e.value) : Promise.resolve(e.value).then(n, s);
    ...
    if (window === window.top || window.sdkLoaderWasInited) {
        ...
        window.YaGames = {
            init: o => {
                var d;
                return s ? null == (d = window.YaGames) ? void 0 : d.init(o) : i ? Promise.reject(v) : a ? (console.warn("YaGames was initialized"),
                a) : (a = new Promise(( (a, s) => {
                    e = a,
                    r = s,
                    t = o,
        ...
        const u = e => {
          ...
          , g = (o, a) => {
            ...
            d.onload = () => {
                var o;
                s = !0,
                n && (null == (o = window.YaGames) || o.init(t).then((r => {
                    e(r)
                }
                )).catch((e => {
          ...
          , h = (e, o="") => {
            if (e && (m.test(e) || w.test(e))) {
                const r = new URL(e,"https://app-383448.games.s3.yandex.net");
          ...
          , y = "v2.046fe29ba7a96eb6cf29.js";
        y ? h(y) : o().then((e => {
            const r = new URL(e)
              , o = r.searchParams
              , t = "v2.046fe29ba7a96eb6cf29.js"
              , a = o.get("dvh") || "";
            if (t)
                h(t, a);
            else {
                const e = "v2.046fe29ba7a96eb6cf29.js";
                h(e)
            }
        }
        )).catch((e => {
