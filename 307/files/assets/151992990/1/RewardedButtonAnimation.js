/*BikeObby_RewardedButtonAnimation script that creates glowing rewarded button animation by Emre Şahin - emolingo games */
var BikeObby_RewardedButtonAnimation = pc.createScript('rewardedButtonAnimation');

// initialize code called once per entity
BikeObby_RewardedButtonAnimation.prototype.initialize = function () {
...
BikeObby_RewardedButtonAnimation.prototype.update = function (dt) {
    this.time += dt;
...
// White Cover Opacity
BikeObby_RewardedButtonAnimation.prototype.FadeIn = function () {
...
BikeObby_RewardedButtonAnimation.prototype.onFadeIn = function () {
    this.whiteCover2.element.opacity = this.opacity.value;
};

BikeObby_RewardedButtonAnimation.prototype.onFadeOut = function () {
    this.whiteCover2.element.opacity = this.opacity.value;
};

BikeObby_RewardedButtonAnimation.prototype.FadeOut = function () {
    this.opacity.value = this.whiteCover2.element.opacity;
