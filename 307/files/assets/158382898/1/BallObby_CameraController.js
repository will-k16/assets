/*BallObbyCameraController script that handles camera by Emre Şahin - emolingo games */
var BallObbyCameraController = pc.createScript('ballObbyCameraController');

BallObbyCameraController.attributes.add('mouseSpeed', { type: 'number', default: 1.4, description: 'Mouse Sensitivity' });

// Called once after all resources are loaded and before the first update
BallObbyCameraController.prototype.initialize = function () {
...
BallObbyCameraController.prototype.reset = function () {
...
BallObbyCameraController.prototype.onMouseWheel = function (event) {
    ...
    BallObby_Utils.setItem("mouseScroll", this.app.mouseScroll);
...
BallObbyCameraController.prototype.setSensitivity = function () {
    /*
...
BallObbyCameraController.prototype.removeEventCallbacks = function () {
    this.app.mouse.off("mousemove", this.onMouseMove, this);
    this.app.mouse.off("mouseup", this.onMouseUp, this);
    this.app.mouse.off("mousedown", this.onMouseDown, this);
};

BallObbyCameraController.prototype.addEventCallbacks = function () {
    this.app.mouse.on("mousemove", this.onMouseMove, this);
    this.app.mouse.on("mouseup", this.onMouseUp, this);
    this.app.mouse.on("mousedown", this.onMouseDown, this);
};
...
BallObbyCameraController.prototype.postUpdate = function (dt) {
...
BallObbyCameraController.prototype.onMouseMove = function (e) {
...
BallObbyCameraController.prototype.onMouseDown = function (e) {
    this.app.firstTouch = true;
};

BallObbyCameraController.prototype.getWorldPoint = function () {
