var LOCameraController = pc.createScript('loCameraController');

LOCameraController.attributes.add('mouseSpeed', { type: 'number', default: 1.4, description: 'Mouse Sensitivity' });
LOCameraController.attributes.add('fpsCamera', { type: 'entity' });

// Called once after all resources are loaded and before the first update
LOCameraController.prototype.initialize = function () {
...
LOCameraController.prototype.resetCamera = function () {
    this.rayEnd = this.entity.parent.findByName('RaycastEndPoint');
    this.originEntity = this.entity.parent;
}

LOCameraController.prototype.onOrientationChange = function () {
...
LOCameraController.prototype.setMouseZoom = function (dt) {
    if (this.app.isFPS) {
...
LOCameraController.prototype.onMouseWheel = function (event) {
...
LOCameraController.prototype.setSensitivity = function () {
    /*
...
LOCameraController.prototype.removeEventCallbacks = function () {
...
LOCameraController.prototype.addEventCallbacks = function () {
...
LOCameraController.prototype.postUpdate = function (dt) {
...
LOCameraController.prototype.onMouseMove = function (e) {
...
LOCameraController.prototype.onMouseDown = function (e) {
    this.app.firstTouch = true;
};

LOCameraController.prototype.getWorldPoint = function () {
