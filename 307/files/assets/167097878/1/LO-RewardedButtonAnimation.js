var LoRewardedButtonAnimation = pc.createScript('loRewardedButtonAnimation');

// initialize code called once per entity
LoRewardedButtonAnimation.prototype.initialize = function () {
...
LoRewardedButtonAnimation.prototype.update = function (dt) {
    this.time += dt;
...
// White Cover Opacity
LoRewardedButtonAnimation.prototype.FadeIn = function () {
...
LoRewardedButtonAnimation.prototype.onFadeIn = function () {
    this.whiteCover2.element.opacity = this.opacity.value;
};

LoRewardedButtonAnimation.prototype.onFadeOut = function () {
    this.whiteCover2.element.opacity = this.opacity.value;
};

LoRewardedButtonAnimation.prototype.FadeOut = function () {
    this.opacity.value = this.whiteCover2.element.opacity;
